...
const PAYLINES_DATA = [
  {
    pick: 'Pick 2',
    note: 'Two-digit numbers, 00\u201399. Boxed only pays the 2-Way category when both digits are different; numbers with two identical digits are not eligible for a Box payout.',
    rows: [
  ...
  {
    pick: 'Pick 3',
    note: 'Three-digit numbers, 000\u2013999. Boxed only pays the 6-Way category when all three digits are different; combinations with repeated digits are not eligible for a Box payout.',
    rows: [
  ...
  {
    pick: 'Pick 4',
    note: 'Four-digit numbers, 0000\u20139999. Boxed only pays the 24-Way category when all four digits are different; combinations with repeated digits are not eligible for a Box payout.',
    rows: [
  ...
  {
    pick: 'Pick 5',
    note: 'Five-digit numbers, 00000\u201399999. Boxed only pays the 120-Way category when all five digits are different; combinations with repeated digits are not eligible for a Box payout.',
    rows: [
